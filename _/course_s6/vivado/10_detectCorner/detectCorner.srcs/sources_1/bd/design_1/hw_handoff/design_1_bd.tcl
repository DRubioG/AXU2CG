...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net detectCorner_0_video_out [get_bd_intf_pins axis_subset_converter_1/S_AXIS] [get_bd_intf_pins detectCorner_0/video_out]
  ...
  connect_bd_net -net axis_subset_converter_0_m_axis_tdata [get_bd_pins axis_subset_converter_0/m_axis_tdata] [get_bd_pins detectCorner_0/video_in_TDATA]
  connect_bd_net -net axis_subset_converter_0_m_axis_tdest [get_bd_pins axis_subset_converter_0/m_axis_tdest] [get_bd_pins detectCorner_0/video_in_TDEST]
  connect_bd_net -net axis_subset_converter_0_m_axis_tid [get_bd_pins axis_subset_converter_0/m_axis_tid] [get_bd_pins detectCorner_0/video_in_TID]
  connect_bd_net -net axis_subset_converter_0_m_axis_tkeep [get_bd_pins axis_subset_converter_0/m_axis_tkeep] [get_bd_pins detectCorner_0/video_in_TKEEP]
  connect_bd_net -net axis_subset_converter_0_m_axis_tlast [get_bd_pins axis_subset_converter_0/m_axis_tlast] [get_bd_pins detectCorner_0/video_in_TLAST]
  connect_bd_net -net axis_subset_converter_0_m_axis_tstrb [get_bd_pins axis_subset_converter_0/m_axis_tstrb] [get_bd_pins detectCorner_0/video_in_TSTRB]
  connect_bd_net -net axis_subset_converter_0_m_axis_tuser [get_bd_pins axis_subset_converter_0/m_axis_tuser] [get_bd_pins detectCorner_0/threshold_ap_vld] [get_bd_pins detectCorner_0/video_in_TUSER]
  connect_bd_net -net axis_subset_converter_0_m_axis_tvalid [get_bd_pins axis_subset_converter_0/m_axis_tvalid] [get_bd_pins detectCorner_0/video_in_TVALID]
  connect_bd_net -net cpu_reg_v1_0_0_reg_out5 [get_bd_pins cpu_reg_v1_0_0/reg_out5] [get_bd_pins detectCorner_0/threshold]
  connect_bd_net -net detectCorner_0_video_in_TREADY [get_bd_pins axis_subset_converter_0/m_axis_tready] [get_bd_pins detectCorner_0/video_in_TREADY]
  ...
  connect_bd_net -net proc_sys_reset_150M_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins cpu_reg_v1_0_0/s00_axi_aresetn] [get_bd_pins detectCorner_0/ap_rst_n] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aresetn] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aresetn] [get_bd_pins proc_sys_reset_150M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins v_demosaic_0/ap_rst_n] [get_bd_pins v_gamma_lut_0/ap_rst_n]
