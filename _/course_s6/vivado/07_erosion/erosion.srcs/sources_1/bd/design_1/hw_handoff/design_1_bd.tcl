...
proc create_root_design { parentCell } {
  ...
  # Create instance: erosion_0, and set properties
  set erosion_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:erosion:1.0 erosion_0 ]
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS [get_bd_intf_pins axis_subset_converter_0/M_AXIS] [get_bd_intf_pins erosion_0/src]
  ...
  connect_bd_intf_net -intf_net erosion_0_dst [get_bd_intf_pins axis_subset_converter_1/S_AXIS] [get_bd_intf_pins erosion_0/dst]
