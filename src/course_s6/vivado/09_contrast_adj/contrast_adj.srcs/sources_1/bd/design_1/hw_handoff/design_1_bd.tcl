...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net contrastadj_0_dst_axi [get_bd_intf_pins axis_subset_converter_1/S_AXIS] [get_bd_intf_pins contrastadj_0/dst_axi]
  ...
  connect_bd_net -net axis_subset_converter_0_m_axis_tdata [get_bd_pins axis_subset_converter_0/m_axis_tdata] [get_bd_pins contrastadj_0/src_axi_TDATA]
  connect_bd_net -net axis_subset_converter_0_m_axis_tdest [get_bd_pins axis_subset_converter_0/m_axis_tdest] [get_bd_pins contrastadj_0/src_axi_TDEST]
  connect_bd_net -net axis_subset_converter_0_m_axis_tid [get_bd_pins axis_subset_converter_0/m_axis_tid] [get_bd_pins contrastadj_0/src_axi_TID]
  connect_bd_net -net axis_subset_converter_0_m_axis_tkeep [get_bd_pins axis_subset_converter_0/m_axis_tkeep] [get_bd_pins contrastadj_0/src_axi_TKEEP]
  connect_bd_net -net axis_subset_converter_0_m_axis_tlast [get_bd_pins axis_subset_converter_0/m_axis_tlast] [get_bd_pins contrastadj_0/src_axi_TLAST]
  connect_bd_net -net axis_subset_converter_0_m_axis_tstrb [get_bd_pins axis_subset_converter_0/m_axis_tstrb] [get_bd_pins contrastadj_0/src_axi_TSTRB]
  connect_bd_net -net axis_subset_converter_0_m_axis_tuser [get_bd_pins axis_subset_converter_0/m_axis_tuser] [get_bd_pins contrastadj_0/adj_ap_vld] [get_bd_pins contrastadj_0/src_axi_TUSER]
  connect_bd_net -net axis_subset_converter_0_m_axis_tvalid [get_bd_pins axis_subset_converter_0/m_axis_tvalid] [get_bd_pins contrastadj_0/src_axi_TVALID]
  connect_bd_net -net contrastadj_0_src_axi_TREADY [get_bd_pins axis_subset_converter_0/m_axis_tready] [get_bd_pins contrastadj_0/src_axi_TREADY]
  connect_bd_net -net cpu_reg_v1_0_0_reg_out5 [get_bd_pins contrastadj_0/adj] [get_bd_pins cpu_reg_v1_0_0/reg_out5]
