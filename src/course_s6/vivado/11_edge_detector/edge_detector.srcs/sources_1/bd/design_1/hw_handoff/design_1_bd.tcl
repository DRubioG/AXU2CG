...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net edge_detector_0_dst [get_bd_intf_pins axis_subset_converter_1/S_AXIS] [get_bd_intf_pins edge_detector_0/dst]
  ...
  connect_bd_net -net axis_subset_converter_0_m_axis_tdata [get_bd_pins axis_subset_converter_0/m_axis_tdata] [get_bd_pins edge_detector_0/src_TDATA]
  connect_bd_net -net axis_subset_converter_0_m_axis_tdest [get_bd_pins axis_subset_converter_0/m_axis_tdest] [get_bd_pins edge_detector_0/src_TDEST]
  connect_bd_net -net axis_subset_converter_0_m_axis_tid [get_bd_pins axis_subset_converter_0/m_axis_tid] [get_bd_pins edge_detector_0/src_TID]
  connect_bd_net -net axis_subset_converter_0_m_axis_tkeep [get_bd_pins axis_subset_converter_0/m_axis_tkeep] [get_bd_pins edge_detector_0/src_TKEEP]
  connect_bd_net -net axis_subset_converter_0_m_axis_tlast [get_bd_pins axis_subset_converter_0/m_axis_tlast] [get_bd_pins edge_detector_0/src_TLAST]
  connect_bd_net -net axis_subset_converter_0_m_axis_tstrb [get_bd_pins axis_subset_converter_0/m_axis_tstrb] [get_bd_pins edge_detector_0/src_TSTRB]
  connect_bd_net -net axis_subset_converter_0_m_axis_tuser [get_bd_pins axis_subset_converter_0/m_axis_tuser] [get_bd_pins edge_detector_0/src_TUSER] [get_bd_pins edge_detector_0/threshold_ap_vld]
  connect_bd_net -net axis_subset_converter_0_m_axis_tvalid [get_bd_pins axis_subset_converter_0/m_axis_tvalid] [get_bd_pins edge_detector_0/src_TVALID]
  connect_bd_net -net cpu_reg_v1_0_0_reg_out4 [get_bd_pins cpu_reg_v1_0_0/reg_out4] [get_bd_pins edge_detector_0/threshold]
  connect_bd_net -net edge_detector_0_src_TREADY [get_bd_pins axis_subset_converter_0/m_axis_tready] [get_bd_pins edge_detector_0/src_TREADY]
